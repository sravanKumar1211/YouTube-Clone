...
// function PofilePage({sideBar}) {
//     const channelContant = [1, 2, 3, 4, 5, 6, 7, 8, 9];
//   return (
//     <>
//     <div className='flex w-100% pt-8 px-8 pb-0 box-border'>
//         {/* sidebar */}
//         <SideBar sideBar={sideBar}></SideBar>


//         {/* profile part */}
//         <div className='flex flex-col overflow-x-hidden flex-1 ml-[270px] mt-[50px] justify-center align-middle'>
//             {/* channal detaila */}
//             <div className=''>
//                 <div className='flex py-0 px-20'>
//                     {/* chanal logo or image */}
//                     <img className='w-100% rounded-4xl' src=" https://cdn.fliki.ai/image/page/660ba680adaa44a37532fd97/6663112070e1cfda27f86585.jpg" alt="" />
//                 </div>
//                 {/* details */}
//                 <div className='flex flex-col'>
//                     <h1>channal name</h1>
//                     <span>chanal owner </span>
//                     <span>No.of videos 5</span>
//                     <span> channal discription</span>
//                 </div>
//             </div>
//             <hr />
//             {/* video contant section */}
//             <div>
//                 <span>Videos</span>
//                 <span>Shorts</span>
//                 <span>PlayList</span>
